...
class HistoryGoodsViewModel: BaseViewModel {
    override init() {
        super.init()
    }
...
extension HistoryGoodsViewModel: UITableViewDelegate {
...
extension HistoryGoodsViewModel: UITableViewDataSource {
